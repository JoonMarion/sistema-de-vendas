...
class Produtos(models.Model):
    ...
    valor_unitario = models.DecimalField('Valor Unitário', max_digits=5, decimal_places=2, null=False, blank=False)
    ...
    qtde_estoque = models.DecimalField('Quantidade em estoque', max_digits=5, decimal_places=2, null=False, blank=False)
